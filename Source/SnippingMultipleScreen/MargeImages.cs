...
{
    public static class MargeImages
    {
        ...
        public static System.Drawing.Bitmap Combine(BitmapSource[] files)
        {
            //read all images into memory
            List<System.Drawing.Bitmap> images = new List<System.Drawing.Bitmap>();
            System.Drawing.Bitmap finalImage = null;
            ...
            try
            {
                ...
                foreach (BitmapSource image in files)
                {
                    //create a Bitmap from the file and add it to the list
                    System.Drawing.Bitmap bitmap = image.BitmapFromSource();
